...
project = 'MLOps Workflow with Kubeflow and AML'
copyright = 'Equinor'
author = 'MLOps Workflow with Kubeflow and AML'
...
html_theme_options = {
    "description": "This showcases a ML Ops workflow to go from Jupyter notebook to training in Kubeflow and deploying a trained model to Azure ML",
    "extra_nav_links": {
        "Index": "genindex.html",
