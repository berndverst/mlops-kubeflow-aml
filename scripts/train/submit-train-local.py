...
def submit(experiment_name: str,
    ...
    model = run.register_model(
        model_name='mlops-workflow-with-kubeflow-and-aml',
        model_path='outputs/model/mlops-workflow-with-kubeflow-and-aml.joblib')
...
def main(arguments: list):
    ...
    parser.add_argument('--experiment', type=str,
                        default='mlops-workflow-with-kubeflow-and-aml-local',
